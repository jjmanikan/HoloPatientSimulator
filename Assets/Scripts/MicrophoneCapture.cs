...
public class MicrophoneCapture : MonoBehaviour
{
	...
	public void StopListening()
	{
		if (recordingActive)
		{
			...
			StartCoroutine(StartVoiceRequest("https://dialogflow.googleapis.com/v2/projects/aragenttest-hugf/agent/sessions/34563:detectIntent",
	...
	IEnumerator StartVoiceRequest(String url, String AccessToken, object parameter)
	{
		...
		if (samples != null)
		{
			...
			//requestBody.queryInput.inputAudio = sampleString;
